...
5. Generating concrete follow-up actions`
    },
    {
      ...
      description: 'Specialized prompt for sentiment and emotion detection',
      category: 'sentiment',
      version: '1.0',
      lastModified: new Date().toISOString(),
...
Provide detailed sentiment analysis:
{
  ...
  "relationship_health": {
    ...
    },
    {
      ...
      description: 'Prompt focused on identifying follow-up actions and tasks',
      category: 'actions',
      version: '1.0',
      lastModified: new Date().toISOString(),
...
Identify and categorize all actions:
{
  ...
  "information_requests": [
    ...
    },
    {
      ...
      description: 'Specialized prompt for identifying product feature requests and improvements',
      category: 'insights',
      version: '1.0',
      lastModified: new Date().toISOString(),
...
Extract all product-related requests:
{
  ...
  const savePrompt = async () => {
    ...
    try {
      ...
      localStorage.setItem('ai-prompt-templates', JSON.stringify(updatedTemplates));
      setHasUnsavedChanges(false);
